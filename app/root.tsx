...
const Header = (): JSX.Element => {
  return (
    <Link to="/">
    <div className="space-between fixed z-10 left-0 top-0 flex p-4 min-w-full h-20 text-gray-600 font-note text-3xl  bg-white border-b-2 border-gray-600 md:p-2 md:text-5xl">
      <div className="flex-grow">Moa Clay Collection</div>
      <div className="relative py-0 md:py-3">
        <svg
