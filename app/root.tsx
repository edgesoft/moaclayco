...
function Document({
  ...
  return (
    <html lang="en">
      ...
      <body>
        <div className="fixed hover:bg-rosa bg-white text-gray-600 flex p-4 h-20  font-note text-3xl border-b-2 border-gray-600 md:p-2 md:text-5xl min-w-full">
...
export default function App() {
  ...
  return (
    <Document>
      <Outlet />
      <div className="fixed bottom-0 flex flex-grow w-full bg-gray-50">
        <footer className="flex p-4 bg-gray-50">
