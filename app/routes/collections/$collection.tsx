import {MetaFunction, LoaderFunction, useLoaderData, useTransition} from 'remix'
...
const Magnifier: React.FC<MagnifierProps> = ({imageUrl, close}): JSX.Element |  null => {
  ...
  return (<div className="fixed z-10 left-0 top-0 w-full h-full overflow-scroll">
  <div
